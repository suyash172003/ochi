  ...
  return (
    <div className='w-screen h-screen overflow-hidden'>
        <div className="mt-4 px-20 py-10">
            <h1 className='text-6xl NeueMontreal'>Featured Projects</h1>
        </div>
        ...
        <div className='px-10 py-10 flex justify-center items-center gap-10 overflow-hidden'>
            <motion.div onHoverStart={()=>handleHover(0)} onHoverEnd={()=>handleHoverEnd(0)} className='card container w-1/2 h-[65vh] '>
              <div className='h-full relative flex justify-between items-center'>
                <img src="https://ochi.design/wp-content/uploads/2023/10/Fyde_Illustration_Crypto_2-663x551.png" className='bg-cover w-full h-full rounded-3xl' alt="FYBE Project"></img>
