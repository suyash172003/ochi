...
function Footer() {
  return (
    <div className='h-screen w-screen'>
        <div className='px-20 py-10 flex justify-between items-center h-full'>
            <div className='h-full flex flex-col justify-between'>
                <div className='w-1/2 uppercase text-8xl font-semibold leading-none'>
                    <h1>Eye-</h1>
                    <h1>Opening</h1>
                </div>
                <div className='logo'>
            ...
            <div className='w-1/2 h-full flex flex-col'>
                <h1 className='top-0 uppercase text-8xl font-semibold leading-none'>Presentations</h1>
                <div className='social mt-8 flex flex-col gap-3'>
                    <h1 className='text-1xl font-light'>S:</h1>
                    <h1 className='text-1xl font-light flex flex-col'>{["Instagram","Behance","Facebook","Linkedin"].map((items,index)=>(<a href="#">{items}</a>))}</h1>
                </div>
            </div>
        </div>
    </div>
